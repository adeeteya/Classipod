...
class AppLocalizationsNso extends AppLocalizations {
  ...
  @override
  String get audioAccessPermissionTitle => 'Tumelelo ya phihlelelo ya modumo e a nyakega';

  @override
  String get audioAccessPermissionContent => 'Hle fa difaele tša mamelwang phihlelelo go re dumelela go bapala difaele tša gago tša mmino.';

  @override
  String get audioAccessPermissionPermanentlyDeniedTitle => 'Tumelelo ya Phihlelelo ya Modumo e gannwe';

  @override
  String get audioAccessPermissionPermanentlyDeniedContent => 'Hle fa difaele tša modumo phihlelelo ya tirišo ye ka go dipeakanyo tša sedirišwa go re dumelela go bapala difaele tša gago tša mmino.';
  ...
  @override
  String get touchSoundsDialogContent => 'Hle kgontšha medumo ya go kgoma go tšwa go dipeakanyo tša tshepedišo go kwa medumo ya maotwana ya go kgotla';
  ...
  @override
  String get donateSettingDescription => 'Ge o rata app ye, hle nagana ka go neela.';
  ...
  @override
  String get disableBatteryOptimizationContent => 'Hle thibela betri optimization bakeng sa tiriso ye ka di-setting tsa sesebediswa ho dumella background bapala mmino.';
  ...
  @override
  String get deviceControlMenuTutorialText => 'Suthiša monwana wa gago wa godimo gabonolo go dikologa leotwana la go klika go sepelasepela thepong';

  @override
  String get centerButtonMenuTutorialText => 'Tobetsa konopo ya Setsi go kgetha aetheme ya menu yeo e hlaotswego';

  @override
  String get playPauseMenuTutorialText => 'Tobetsa konopo ye go bapala goba go khutša koša';

  @override
  String get nextButtonMenuTutorialText => 'Tobetsa konopo ena ho tlola ho pina e latelang';

  @override
  String get previousButtonMenuTutorialText => 'Tobetsa konopo ye go boela morago goba go boela morago go koša ya go feta';

  @override
  String get menuButtonTutorialText => 'Tobetsa konopo ye go boela morago go thepo ya peleng. O ka tobetša le go e swara go tšwa go skrine sefe goba sefe se sengwe go ya ka go lebanya go lenaneo le legolo.';

  @override
  String get deviceScreenMenuTutorialText => 'Ye ke skrine sa pontšho. Mokgwa wa Skrine wa go kgoma le Split Screen di kgontšhwa ka go ikemela gomme di ka beakanywa go ya pele ka go dipeakanyo.';

  @override
  String get deviceControlNowPlayingTutorialText => 'Suthiša monwana wa gago wa godimo go dikologa leotwana la go klika go beakanya bophagamo';

  @override
  String get centerButtonNowPlayingTutorialText => 'Tobetsa konopo ya bogareng go sepela ka gare ga baara ya go nyaka, bareng ya go gohla le sedirišwa sa go thelela sa go hlakanya. Tobetsa le ho tshwara konopo ya setsi ho fihlella dikgetho tse eketsehileng.';

  @override
  String get nextButtonNowPlayingTutorialText => 'Tobetsa o tshware konopo ena ho itima lijo pele pina';

  @override
  String get previousButtonNowPlayingTutorialText => 'Tobetsa o tshware konopo ye go bušetša koša morago';

  @override
  String get deviceControlSearchTutorialText => 'Suthiša monwana wa gago wa godimo gabonolo go dikologa leotwana la go kgotla go hlaola alfabete';

  @override
  String get centerButtonSearchTutorialText => 'Tobetsa konopo ya setsi ho kgetha alfabeta e hlalositsoeng';

  @override
  String get nextButtonSearchTutorialText => 'Tobetsa konopo ye go oketša sekgoba';

  @override
  String get previousButtonSearchTutorialText => 'Tobetsa konopo ena ho hlakola tlhaku ya ho qetela';

  @override
  String get menuButtonSearchTutorialText => 'Tobetsa konopo ye go tswalela khiiboto le go dirišana le dipoelo tša nyakišišo';
}
